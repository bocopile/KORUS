...
*관점별 성적표 (Claude 서브에이전트)*
- 펀더멘털 관점: 적중률 {hit}% | 수익 기여 {pnl}% | 단독 정답 {n}회
- 뉴스 관점: 적중률 {hit}% | 수익 기여 {pnl}% | 단독 정답 {n}회
- 리스크 관점: 적중률 {hit}% | 수익 기여 {pnl}% | 단독 정답 {n}회
- 합의 불일치 → HOLD 강제: {n}회
...
*관점별 연간 성적표 (Claude 서브에이전트)*
- 펀더멘털 관점: 적중률 {hit}% | 수익 기여 {contrib}% | 단독 정답 {n}회
- 뉴스 관점: 적중률 {hit}% | 수익 기여 {contrib}% | 단독 정답 {n}회
- 리스크 관점: 적중률 {hit}% | 수익 기여 {contrib}% | 단독 정답 {n}회
